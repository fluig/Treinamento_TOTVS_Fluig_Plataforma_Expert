...
function createDataset(fields, constraints, sortFields) {
    ...
    var datasetPrincipal = DatasetFactory.getDataset("ds_aprovadores", null, constraints, null);
    ...
    for (var i = 0; i < datasetPrincipal.rowsCount; i++) {
        ...
        //Busca o dataset
        var datasetFilhos = DatasetFactory.getDataset("ds_aprovadores", null, constraintsFilhos, null);

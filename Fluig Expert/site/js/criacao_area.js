var htmlTitle = 'criacao_area - Fluig Documental Process Site';
var headerString = 'Fluig Expert - Fluig Documental Process Site';
var selectedTab = 0;

var currentProcess = Properties("id,criacao_area|name,criacao_area|version,1");
var processImageName = 'criacao_area.png';
...
componentList.push(Component('rect','260.0,208.0,366.0,264.0','Atividade','tasknormal.png',Properties("id,task5|name,Integração")));
componentList.push(Component('rect','210.0,20.0,315.0,75.0','Anotação','annotation.png',Properties("id,annotationtask7|name,Start")));
componentList.push(Component('circle','447.5,235.5,17.5','Final','endnormal.png',Properties("id,endevent9|name,Fim")));
componentList.push(Component('rect','40.0,155.0,841.0,300.0','SwimLane','type.swim.lane.png',Properties("id,swimlane3|name,Assignee")));
componentList.push(Component('rect','40.0,10.0,841.0,155.0','SwimLane','type.swim.lane.png',Properties("id,swimlane2|name,Reporter")));
componentList.push(Component('rect','10.0,10.0,40.0,300.0','Pool','pool.png',Properties("id,pool1|name,Pool")));
